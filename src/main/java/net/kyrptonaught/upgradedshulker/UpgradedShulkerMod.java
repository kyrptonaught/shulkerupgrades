...
public class UpgradedShulkerMod implements ModInitializer {
    ...
    public static final ItemGroup GROUP = FabricItemGroup.builder(new Identifier(MOD_ID, "shulkers")).icon(() -> new ItemStack(ShulkersRegistry.upgradedShulkerBlocks.get(ShulkerUpgrades.MATERIAL.NETHERITE))).build();
