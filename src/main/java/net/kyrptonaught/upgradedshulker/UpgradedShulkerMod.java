...
public class UpgradedShulkerMod implements ModInitializer, RegisterQuickShulker {
    ...
    // public static final RuntimeResourcePack RESOURCE_PACK = RuntimeResourcePack.create(UpgradedShulkerMod.MOD_ID + ":" + UpgradedShulkerMod.MOD_ID);
