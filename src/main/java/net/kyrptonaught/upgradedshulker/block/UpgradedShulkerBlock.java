...
public class UpgradedShulkerBlock extends ShulkerBoxBlock implements UpgradedShulker, UpgradableShulker {
    ...
    public UpgradedShulkerBlock(ShulkerUpgrades.MATERIAL upgradedshulkertype, DyeColor color, Settings blockSettings) {
        ...
        Registry.register(Registries.ITEM, new Identifier("us", colorName + upgradedshulkertype.name + "shulker"), new BlockItem(this, itemSettings));
        ItemGroupEvents.modifyEntriesEvent(UpgradedShulkerMod.GROUP).register(this::appendStacks);
    }
    ...
    private void appendStacks(FabricItemGroupEntries entries) {
        ItemStack shulkerStack = new ItemStack(this);
        entries.add(shulkerStack.copy());
